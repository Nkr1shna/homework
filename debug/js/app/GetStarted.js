BH.add("GetStarted", function() {
  ...
  BH.GetStarted = BH.Class(BH.BaseCompositeInput, {
    _init: function(node, cfg) {
      ...
      this.set(
        "email",
        new BH.EmailInput(this._node.find(".bh-id-email-container"))
      );
      ...
      this._addInput({
        ...
        validationRules: [BH.ValidationRules.Required]
      });
      ...
      this._addInput({
        ...
        validationRules: [BH.ValidationRules.Phone, BH.ValidationRules.Required]
      });
    },
        ...
        BH.StylingService.save_user_info(
          {
            ...
            //me instead of this should be used
    ...
    isComplete: function() {
      return (
        !this.get("firstName").isEmptyTransient() &&
        !this.get("lastName").isEmptyTransient() &&
        !this.get("phone").isEmptyTransient() &&
        !this.get("email").isEmptyTransient()
      );
    },
